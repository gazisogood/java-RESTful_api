...
public class ClientController {
    ...
    public ResponseEntity<String> createNewClient(@Valid @RequestBody ClientDto clientDto) {
    ...
    public ResponseEntity<List<Client>> findByNameAndSurname(@RequestParam String name, @RequestParam String surname) {
    ...
    public ResponseEntity<List<Client>> findAll(@RequestParam(required = false) Integer limit,
                                                @RequestParam(required = false) Integer offset) {
        if (limit != null && offset != null)
            return clientService.findAll(limit, offset);
        else
    ...
    public ResponseEntity<String> updateClientAddress(@PathVariable("id") Long id, @Valid @RequestBody AddressDto addressDto) {
        return clientService.update(id, addressDto);
    }
}
