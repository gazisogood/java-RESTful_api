...
import ru.school21.edu.backend.services.SupplierService;
...
public class SupplierController {
    ...
    public ResponseEntity<String> createNewSupplier(@Valid @RequestBody SupplierDto supplierDto) {
    ...
    public ResponseEntity<String> updateSupplierAddress(@PathVariable Long id, @Valid @RequestBody AddressDto addressDto) {
        return supplierService.update(id, addressDto);
    }
